...
//  }
//
//  public static List<File> downloadChunks(List<URL> chunksUrls, String destDir) {
...
//          URL m3u8Url = HLSUtils.getHighestQualityM3u8Url(masterM3u8Url, delay / 1000L);
//          Set<URL> downloadedChunksURL = new HashSet();
//          List<File> downloadedChunksFiles = new ArrayList();
//          int i = 0;
//
//          while(true) {
//            List<URL> chunkUrls = HLSUtils.getChunkUrlsFormM3u8(m3u8Url);
...
//              List<File> chunkFiles = HLSUtils.downloadChunks(newChunks, Config.TMP_DIR_ADD);
...
//              }
//
//              HLSUtils.concatFiles(new File(Config.DEST_DIR_ADD + File.separator + targetFileName + ".ts"), downloadedChunksFiles);
//              HLSUtils.deleteFiles(downloadedChunksFiles);
